...
pub struct ProjectReference {
	/// The path property of each reference can point to a directory containing
	/// a tsconfig.json file, or to the config file itself (which may have any
	/// name).
	pub path:PathBuf,
...
impl TsConfig {
	...
	pub(crate) fn parse(root:bool, path:&Path, json:&mut str) -> Result<Self, serde_json::Error> {
